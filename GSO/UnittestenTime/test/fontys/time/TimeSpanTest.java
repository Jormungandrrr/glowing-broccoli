...
public class TimeSpanTest {
    ...
    public void testLength() {
        ...
        ITime Begintijd = new Time(1992,10,13,7,40);
        ITime Eindtijd = new Time(1992,10,13,7,41);
        TimeSpan instance = new TimeSpan(Begintijd, Eindtijd);
        int expResult = 0;
    ...
    public void testUnionWith2() {
        ...
        ITimeSpan timeSpan = new TimeSpan(Begintijd,Eindtijd);
        TimeSpan instance = new TimeSpan(Begintijd1,Eindtijd1);
        ITimeSpan expResult = new TimeSpan(Begintijd1,Eindtijd);
        ITimeSpan result = instance.unionWith(timeSpan);
        assertEquals(expResult.getBeginTime().getMinutes(), result.getBeginTime().getMinutes());
        assertEquals(expResult.getEndTime().getMinutes(), result.getEndTime().getMinutes());
        // TODO review the generated test code and remove the default call to fail.
    }
    ...
    public void testUnionWith3() {
        ...
        ITimeSpan timeSpan = new TimeSpan(Begintijd,Eindtijd);
        TimeSpan instance = new TimeSpan(Begintijd1,Eindtijd1);
        ITimeSpan expResult = new TimeSpan(Begintijd,Eindtijd1);
        ITimeSpan result = instance.unionWith(timeSpan);
        assertEquals(expResult.getBeginTime().getMinutes(), result.getBeginTime().getMinutes());
        assertEquals(expResult.getEndTime().getMinutes(), result.getEndTime().getMinutes());
        // TODO review the generated test code and remove the default call to fail.
    ...
    public void testUnionWith4() {
        ...
        ITimeSpan timeSpan = new TimeSpan(Begintijd,Eindtijd);
        TimeSpan instance = new TimeSpan(Begintijd1,Eindtijd1);
        ITimeSpan expResult = new TimeSpan(Begintijd1,Eindtijd1);
        ITimeSpan result = instance.unionWith(timeSpan);
        assertEquals(expResult.getBeginTime().getMinutes(), result.getBeginTime().getMinutes());
        assertEquals(expResult.getEndTime().getMinutes(), result.getEndTime().getMinutes());
        // TODO review the generated test code and remove the default call to fail.
