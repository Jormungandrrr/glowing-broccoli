...
public class TimeSpan2Test {
    ...
    (expected = IllegalArgumentException.class)
        ...
        TimeSpan2 instance = new TimeSpan2(Begintijd, Eindtijd);
    ...
    @Test
        ...
        ITime Eindtijd = new Time(1993,11,14,8,40);
        TimeSpan2 instance = new TimeSpan2(Begintijd, Eindtijd);
        Long expResult = Long.valueOf(Eindtijd.difference(Begintijd));
    ...
    public void testIsPartOf() {
        ...
        TimeSpan2 instance = new TimeSpan2(Begintijd1,Eindtijd1);
