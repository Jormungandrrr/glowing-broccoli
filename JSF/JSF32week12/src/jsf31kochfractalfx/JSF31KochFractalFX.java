...
public class JSF31KochFractalFX extends Application {
    ...
    private Label lblCalcLeft;
    private Label lblCalcRight;
    private Label lblCalcBottom;
    ...
    //ProgressBar
    private final ProgressBar pbl = new ProgressBar();
    private final ProgressBar pbr = new ProgressBar();
    ...
    public void start(Stage primaryStage) {
        ...
        lblCalcLeft = new Label(". . . . .");
        grid.add(lblCalcLeft, 3, 5);
        grid.add(LeftLabel, 1, 5);
        grid.add(pbl, 2, 5);

        Label RightLabel = new Label("Right Progress");
        lblCalcRight = new Label(". . . . .");
        grid.add(lblCalcRight, 3, 6);
        grid.add(RightLabel, 1, 6);
        grid.add(pbr, 2, 6);

        Label BottomLabel = new Label("Bottom Progress");
        lblCalcBottom = new Label(". . . . .");
        grid.add(lblCalcBottom, 3, 7);
        ...
        grid.add(buttonIncreaseLevel, 4, 5);
    ...
    public void setTextDraw(String text) {
     ...
     public ProgressBar getProgressBarL() {
        return pbl;
    }
    public ProgressBar getProgressBarR() {
        return pbr;
    }
    public ProgressBar getProgressBarB() {
        return pbb;
    }
    public Label getLblCalcLeft() {
        return lblCalcLeft;
    }
    public Label getLblCalcRight() {
        return lblCalcRight;
    }
    public Label getLblCalcBottom() {
        return lblCalcBottom;
    }
